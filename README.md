...
<div align="center">
  ...
  &nbsp;
  <img src="docs/captura-movil.png" alt="Marcador en el móvil" width="200">
</div>

## 🚀 Cómo se usa

1. Entra en **[padellivescorer.com](https://padellivescorer.com)**.
2. Escribe el nombre de las dos parejas (por ejemplo, `Carlos & Dani`).
...
- **SCSS** con variables CSS y container queries para adaptarse a cualquier pantalla.
...
Requisitos: [Node.js](https://nodejs.org) (versión indicada en `.nvmrc`) y Angular CLI.
...
│   └── scoreboard/# Marcador, paneles de pareja y mini pista
